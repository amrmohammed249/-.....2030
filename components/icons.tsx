...
export const PercentIcon = ({ className }: { className?: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 14H9v-2h2v2zm0-4H9V8h2v4zm4-2.5c0 .83-.67 1.5-1.5 1.5S13 12.33 13 11.5s.67-1.5 1.5-1.5.5.17.5.5c0 .17-.09.32-.22.41l-1.03.68c-.37.24-.65.67-.65 1.16V14h-1v-.5c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5z" />
        <path d="M15 16.5c.83 0 1.5-.67 1.5-1.5s-.67-1.5-1.5-1.5-1.5.67-1.5 1.5.67 1.5 1.5 1.5zM9 7.5c.83 0 1.5-.67 1.5-1.5S9.83 4.5 9 4.5 7.5 5.17 7.5 6 8.17 7.5 9 7.5z" />
        <path d="M7 18l10-10" />
    </svg>
);


export const UserShieldIcon = ({ className }: { className?: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const TruckFrontIcon = ({ className }: { className?: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19 14.828V18a2 2 0 01-2 2H7a2 2 0 01-2-2v-3.172M5 12V7a2 2 0 012-2h10a2 2 0 012 2v5M8 5h8M5 12h14M8 12v2m8-2v2" />
